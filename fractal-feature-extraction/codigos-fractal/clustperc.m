                       ...
                       b=b+1;
                        ...
                        if(dist<=r(k))
                            ...
                            if(dist<=r(k))
                                ...
                                if(dist<=r(k))%se o pixel em questão satisfazer a distância de Minkowski
                                     box(a,b)=1;
                                     percCount=percCount+1;
                               else %se não satisfazer a distância de Minkowski
                                   box(a,b)=0;
                                end
                            else
                                box(a,b)=0;
