...
function features = SaveCSVPercCLACDF3Distances(diretorioOrigem1,Actualdir,FileName)

Carac1 = dir([diretorioOrigem1 '/*.mat']);
...
for i = 1:class1
    ...
    orgName=fullfile(diretorioOrigem1,filename);
    load(orgName);
...
% %%%%%%%%%%%%%%%%%%
% features4=zeros(class4,364);
% for i = 1:class4
%     filename=strcat(num2str(i),'.mat');
%     orgName=fullfile(diretorioOrigem2,filename);
%     load(orgName);
%     features4(i, 1:20) = Minkp;
%     features4(i, 21:40) = Minkg;
%     features4(i, 41:60) = Minkh;
%     features4(i, 61:80) = MinkLAC;
%     features4(i, 81:100) = Minknn;
%     features4(i, 101:120) = Euclp;
%     features4(i, 121:140) = Euclg;
%     features4(i, 141:160) = Euclh;
%     features4(i, 161:180) = EuclLAC;
%     features4(i, 181:200) = Euclnn;
%     features4(i, 201:220) = Manhp;
%     features4(i, 221:240) = Manhg;
%     features4(i, 241:260) = Manhh;
%     features4(i, 261:280) = ManhLAC;
%     features4(i, 281:300) = Manhnn;
%     features4(i, 301) = MinkAreaCluster;
%     features4(i, 302) = MinkSkewnessCluster;
%     features4(i, 303) = MinkAreaRatioCluster;
%     features4(i, 304) = MinkMaxCluster;
%     features4(i, 305) = MinkMaxClusterIndex;
%     features4(i, 306) = MinkAreaPerc;
%     features4(i, 307) = MinkSkewnessPerc;
%     features4(i, 308) = MinkAreaRatioPerc;
%     features4(i, 309) = MinkMaxPerc;
%     features4(i, 310) = MinkMaxPercIndex;
%     features4(i, 311) = MinkAreaMaxCluster;
%     features4(i, 312) = MinkSkewnessMaxCluster;
%     features4(i, 313) = MinkAreaRatioMaxCluster;
%     features4(i, 314) = MinkMaxMaxCluster;
%     features4(i, 315) = MinkMaxMaxClusterIndex;
%     features4(i, 316) = EuclAreaCluster;
%     features4(i, 317) = EuclSkewnessCluster;
%     features4(i, 318) = EuclAreaRatioCluster;
%     features4(i, 309) = EuclMaxCluster;
%     features4(i, 320) = EuclMaxClusterIndex;
%     features4(i, 321) = EuclAreaPerc;
%     features4(i, 322) = EuclSkewnessPerc;
%     features4(i, 323) = EuclAreaRatioPerc;
%     features4(i, 324) = EuclMaxPerc;
%     features4(i, 325) = EuclMaxPercIndex;
%     features4(i, 326) = EuclAreaMaxCluster;
%     features4(i, 327) = EuclSkewnessMaxCluster;
%     features4(i, 328) = EuclAreaRatioMaxCluster;
%     features4(i, 329) = EuclMaxMaxCluster;
%     features4(i, 330) = EuclMaxMaxClusterIndex;
%     features4(i, 331) = ManhAreaCluster;
%     features4(i, 332) = ManhSkewnessCluster;
%     features4(i, 333) = ManhAreaRatioCluster;
%     features4(i, 334) = ManhMaxCluster;
%     features4(i, 335) = ManhMaxClusterIndex;
%     features4(i, 336) = ManhAreaPerc;
%     features4(i, 337) = ManhSkewnessPerc;
%     features4(i, 338) = ManhAreaRatioPerc;
%     features4(i, 339) = ManhMaxPerc;
%     features4(i, 340) = ManhMaxPercIndex;
%     features4(i, 341) = ManhAreaMaxCluster;
%     features4(i, 342) = ManhSkewnessMaxCluster;
%     features4(i, 343) = ManhAreaRatioMaxCluster;
%     features4(i, 344) = ManhMaxMaxCluster;
%     features4(i, 345) = ManhMaxMaxClusterIndex;
%     features4(i, 346) = MinkAreaLAC;
%     features4(i, 347) = MinkSkewnessLAC;
%     features4(i, 348) = MinkAreaRatioLAC;
%     features4(i, 349) = MinkMaxLAC;
%     features4(i, 350) = MinkMaxLACIndex;
%     features4(i, 351) = EuclAreaLAC;
%     features4(i, 352) = EuclSkewnessLAC;
%     features4(i, 353) = EuclAreaRatioLAC;
%     features4(i, 354) = EuclMaxLAC;
%     features4(i, 355) = EuclMaxLACIndex;
%     features4(i, 356) = ManhAreaLAC;
%     features4(i, 357) = ManhSkewnessLAC;
%     features4(i, 358) = ManhAreaRatioLAC;
%     features4(i, 359) = ManhMaxLAC;
%     features4(i, 360) = ManhMaxLACIndex;
%     features4(i, 361) = MinkDF;
%     features4(i, 362) = EuclDF;
%     features4(i, 363) = ManhDF;
%     features4(i, 364) = 3;
% end
...
% Write data to use in GAF
csvwrite(strcat('Onlydata-',FileName,'.csv'),features)
